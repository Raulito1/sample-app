	  ...
	  return (
        ...
        <section className="bg-white/40 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm dark:shadow-none">
          ...
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 mb-4 max-w-2xl">
            This panel embeds your ThoughtSpot Liveboard using the React <code className="font-mono">LiveboardEmbed</code>{' '}
            component. Replace the <span className="font-mono">thoughtSpotHost</span> and{' '}
            <span className="font-mono">liveboardId</span> placeholders with your real values to connect it to your
            environment.
          </p>
