...
const SESSIONS = [
    { id: 'sess_01', user: 'test_user_1', time: '10:42 AM', duration: '4m 12s', events: 124, score: 92, status: 'Completed' },
    { id: 'sess_02', user: 'test_user_1', time: '10:45 AM', duration: '1m 05s', events: 45, score: 35, status: 'Dropped' },
    { id: 'sess_03', user: 'test_user_1', time: '10:48 AM', duration: '12m 30s', events: 512, score: 68, status: 'Friction' },
